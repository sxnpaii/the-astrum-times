      ...
      <div className={sass.Info}>
        {isEvent ?
          ...
          <div className={sass.Event_Date}>
           ...
           <p>
             {moment(postData.event_time).format("h:mm, MMMM Do YYYY")}
            </p>
            </div>
          : null
        }
        ...
        <p className={sass.Published_Date}>{moment(postData.published_date).fromNow()}</p>
      </div>
      <Link to={`/${isEvent ? "events":"posts"}/${postData.id}`} className={sass.Link}>
